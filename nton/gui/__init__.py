...
def about(window: MainWindow) -> None:
    ...
    QMessageBox.about(
        ...
        + "<hr/>"
        + "<p>"
        + " • hacBrewPack by The-4n licensed under GPL-v2 for packing the NSP:<br/>"
        + "&nbsp;&nbsp; <a href='https://github.com/rlaphoenix/hacBrewPack' style='color:blue'>https://github.com/rlaphoenix/hacBrewPack</a><br/>"
        ...
        + " • hptnacp from hacPack by The-4n licensed under GPL-v2 for creating new NACP partitions if the NRO did not have one:<br/>"
        + "&nbsp;&nbsp; <a href='https://github.com/rlaphoenix/hacBrewPack' style='color:blue'>https://github.com/rlaphoenix/hacBrewPack</a><br/>"
        + "<br/>"
