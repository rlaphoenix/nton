...
- Support for Python 3.9. The minimum supported version is now Python 3.10.

### Fixed

- Improved NSP icon quality by raising the JPEG compression quality from 75% to 98% and setting explicit
  4:2:0 chroma subsampling, to better match the format the Switch expects for first-party icons.
- hacBrewPack build failures now report the actual underlying error instead of an unhelpful message.
...
[3.0.1]: https://github.com/rlaphoenix/nton/releases/tag/v3.0.1
